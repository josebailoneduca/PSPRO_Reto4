...
/**
 * Hebra que implementa una version completa del algoritmo de Lamport. Contempla 
 * un numero finito de numeros a asignar y  el control de vuelta de numeros
 * 
...
public class HebraLamportCompleto extends Thread {
	 ...
	 * En su indice 0 pone el numero y en el indice 1 el tipo de vuelta que puede ser 0 o 1
	 * Este ultimo valor sera comparado con vueltaMayor para determinar prioridad entre hebras ante un numero igual
	 * 
	 */
